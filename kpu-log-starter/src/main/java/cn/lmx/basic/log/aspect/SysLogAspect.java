package cn.lmx.basic.log.aspect;
...
import cn.lmx.basic.log.event.SysLogEvent;
import cn.lmx.basic.log.util.LogUtil;
import cn.lmx.basic.log.util.ThreadLocalParam;
...
public class SysLogAspect {
     ...
     *
     * execution(public * cn.lmx.basic.base.controller.*.*(..)) 解释：
     * 第一个* 任意返回类型
     * 第二个* cn.lmx.basic.base.controller包下的所有类
     * 第三个* 类下的所有方法
     * ()中间的.. 任意参数
     *
     * \@annotation(cn.mx.basic.annotation.database.log.WebLog) 解释：
     * 标记了@WebLog 注解的方法
     */
    @Pointcut("execution(public * cn.lmx.basic.base.controller.*.*(..)) || @annotation(cn.lmx.basic.annotation.log.WebLog)")
