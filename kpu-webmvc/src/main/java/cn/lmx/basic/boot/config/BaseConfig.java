...
import cn.lmx.basic.boot.undertow.UndertowServerFactoryCustomizer;
...
public abstract class BaseConfig {
    ...
    public ObjectMapper jacksonObjectMapper(Jackson2ObjectMapperBuilder builder) {
        ...
        // 注册自定义模块
        objectMapper.registerModule(new KpuJacksonModule()).findAndRegisterModules();
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = Constants.PROJECT_PREFIX + ".webmvc", name = "undertow", havingValue = "true", matchIfMissing = true)
