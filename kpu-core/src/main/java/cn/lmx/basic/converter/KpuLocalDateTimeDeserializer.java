...
import static cn.lmx.basic.utils.DateUtils.DEFAULT_DATE_FORMAT_EN;
import static cn.lmx.basic.utils.DateUtils.DEFAULT_DATE_FORMAT_EN_MATCHES;
import static cn.lmx.basic.utils.DateUtils.DEFAULT_DATE_FORMAT_MATCHES;
import static cn.lmx.basic.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT;
import static cn.lmx.basic.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT_EN;
import static cn.lmx.basic.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT_EN_MATCHES;
import static cn.lmx.basic.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT_MATCHES;
import static cn.lmx.basic.utils.DateUtils.SLASH_DATE_FORMAT;
import static cn.lmx.basic.utils.DateUtils.SLASH_DATE_FORMAT_MATCHES;
import static cn.lmx.basic.utils.DateUtils.SLASH_DATE_TIME_FORMAT;
import static cn.lmx.basic.utils.DateUtils.SLASH_DATE_TIME_FORMAT_MATCHES;
...
public class KpuLocalDateTimeDeserializer extends JSR310DateTimeDeserializerBase<LocalDateTime> {
    public static final KpuLocalDateTimeDeserializer INSTANCE = new KpuLocalDateTimeDeserializer();
    ...
    private KpuLocalDateTimeDeserializer() {
        this(DEFAULT_FORMATTER);
    }

    public KpuLocalDateTimeDeserializer(DateTimeFormatter formatter) {
        super(LocalDateTime.class, formatter);
    }

    protected KpuLocalDateTimeDeserializer(KpuLocalDateTimeDeserializer base, Boolean leniency) {
        super(base, leniency);
    }
    ...
    @Override
    protected KpuLocalDateTimeDeserializer withLeniency(Boolean leniency) {
        return new KpuLocalDateTimeDeserializer(this, leniency);
    }
