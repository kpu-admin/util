...
import cn.lmx.basic.cloud.config.OpenFeignAutoConfiguration;
...
@Getter
@Slf4j
public class KpuFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
