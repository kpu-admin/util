...
import cn.lmx.basic.cloud.http.InfoFeignLoggerFactory;
import cn.lmx.basic.cloud.http.RestTemplateHeaderInterceptor;
...
@Slf4j
@AutoConfiguration(
        after = {org.springframework.boot.autoconfigure.web.client.RestTemplateAutoConfiguration.class}
)
