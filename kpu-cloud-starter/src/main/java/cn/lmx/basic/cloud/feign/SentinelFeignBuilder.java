package cn.lmx.basic.cloud.feign;
        ...
        super.invocationHandlerFactory(new InvocationHandlerFactory() {
            ...
            public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
                ...
                if (void.class != fallback) {
                    ...
                    return new KpuSentinelInvocationHandler(target, dispatch, new FallbackFactory.Default<>(fallbackInstance));
                }
                if (void.class != fallbackFactory) {
                    ...
                    return new KpuSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
                }
                return new KpuSentinelInvocationHandler(target, dispatch);
            }
