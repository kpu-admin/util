 ...
 */
@Slf4j
public class KpuSentinelInvocationHandler implements InvocationHandler {
    ...
    KpuSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof KpuSentinelInvocationHandler other) {
