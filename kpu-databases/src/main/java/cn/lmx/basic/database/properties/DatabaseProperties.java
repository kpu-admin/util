package cn.lmx.basic.database.properties;
...
import static cn.lmx.basic.database.properties.DatabaseProperties.PREFIX;
...
public class DatabaseProperties {
     ...
     * <p>
     * 如：kpu项目原始的服务（基础服务、租户服务、认证服务、消息服务、文件服务、网关服务）
     * 总共链接了2个租户库： kpu_base_{TenantId}、kpu_extend_{TenantId}， 这里就要配置2个前缀
     */
    ...
    public static class DefaultId {
        ...
        /**
         * 客户历元，单位为秒。For example 2025-01-01 00:00 (ms: 1463673600000)
         * 可以改成你的项目开始开始的时间
         */
        private String epochStr = "2025-01-01 00:00";
        /**
